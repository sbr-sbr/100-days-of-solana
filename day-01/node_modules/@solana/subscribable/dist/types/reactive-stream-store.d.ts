 ...
 * ```
 */
export declare function createReactiveStoreFromDataPublisherFactory<TData>({ createDataPublisher, dataChannelName, errorChannelName, }: FactoryConfig): ReactiveStreamStore<TData>;
export {};
//# sourceMappingURL=reactive-stream-store.d.ts.map