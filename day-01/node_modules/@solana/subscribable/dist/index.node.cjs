...
var s = class extends globalThis.EventTarget {
  constructor(...t) {
    super(...t), events.setMaxListeners(Number.MAX_SAFE_INTEGER, this);
  }
};
...
function createReactiveActionStore(fn) {
  ...
  const dispatchAsyncWithSignal = async (userSignal, ...args) => {
    ...
    try {
      const result = await promises.getAbortablePromise(fn(signal, ...args), signal);
      if (signal.aborted) {
        throw signal.reason;
      }
