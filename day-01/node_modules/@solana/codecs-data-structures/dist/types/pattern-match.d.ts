...
type GetPatternMatchEncoders<TPatterns extends readonly PatternMatchEncoderEntry<any>[]> = {
    [I in keyof TPatterns]: TPatterns[I] extends readonly [unknown, infer TEncoder extends Encoder<any>] ? TEncoder : never;
};
...
type GetPatternMatchDecoders<TPatterns extends readonly PatternMatchDecoderEntry<any>[]> = {
    [I in keyof TPatterns]: TPatterns[I] extends readonly [unknown, infer TDecoder extends Decoder<any>] ? TDecoder : never;
};
...
type GetPatternMatchCodecs<TPatterns extends readonly PatternMatchCodecEntry<any>[]> = {
    [I in keyof TPatterns]: TPatterns[I] extends readonly [unknown, unknown, infer TCodec extends Codec<any>] ? TCodec : never;
};
/**
 ...
 */
export declare function getPatternMatchEncoder<const TPatterns extends readonly PatternMatchEncoderEntry<any>[]>(patterns: TPatterns & readonly PatternMatchEncoderEntry<GetEncoderTypeFromVariants<GetPatternMatchEncoders<TPatterns>>>[]): GetUnionEncoderType<GetPatternMatchEncoders<TPatterns>>;
/**
 ...
 */
export declare function getPatternMatchDecoder<const TPatterns extends readonly PatternMatchDecoderEntry<any>[]>(patterns: TPatterns): GetUnionDecoderType<GetPatternMatchDecoders<TPatterns>>;
 ...
 */
export declare function getPatternMatchCodec<const TPatterns extends readonly PatternMatchCodecEntry<any>[]>(patterns: TPatterns & readonly PatternMatchCodecEntry<GetEncoderTypeFromVariants<GetPatternMatchCodecs<TPatterns>>>[]): GetUnionCodecType<GetPatternMatchCodecs<TPatterns>>;
export {};
