...
this.globalThis.solanaWeb3 = (function (exports) {
  ...
  function createDependentStructDecoder() {
    return buildFromEntries([]);
  }
  function buildFromEntries(entries) {
    return {
      build() {
        const staticDecoders = entries.map((e22) => e22.staticDecoder);
        const everyStatic = staticDecoders.every((d) => d !== void 0);
        const fixedSize = everyStatic ? sumCodecSizes(staticDecoders.map(getFixedSize)) : null;
        const read = (bytes, offset) => {
          const decoded = {};
          for (const { name, resolveDecoder } of entries) {
            const decoder2 = resolveDecoder(decoded);
      ...
      field(name, decoderOrFactory) {
        const isFactory = typeof decoderOrFactory === "function";
        const resolveDecoder = isFactory ? (fields) => decoderOrFactory(Object.freeze({ ...fields })) : () => decoderOrFactory;
        const nextEntry = {
          name,
          resolveDecoder,
          staticDecoder: isFactory ? void 0 : decoderOrFactory
        };
  ...
  function getTupleEncoder(items, config) {
    ...
    return createEncoder({
      ...
      write: (value, bytes, offset) => {
        var _a2;
        assertValidNumberOfItemsForCodec((_a2 = config == null ? void 0 : config.description) != null ? _a2 : "tuple", items.length, value.length);
  ...
  function getPatternMatchCodec(patterns) {
    return combineCodec(
  ...
  function getPredicateCodec(encodePredicate, decodePredicate, ifTrue, ifFalse) {
    return getUnionCodec(
      [ifTrue, ifFalse],
      (value) => encodePredicate(value) ? 0 : 1,
      (value) => decodePredicate(value) ? 0 : 1
    );
  }
  ...
  function assertShapeMatches(operation, actual, expected) {
    ...
    if (!actualIsStructurallyValid || actual.kind !== expected.kind || expected.signedness !== void 0 && actual.signedness !== expected.signedness || expected.totalBits !== void 0 && actual.totalBits !== expected.totalBits || expected.scale !== void 0 && actual.scale !== expected.scale) {
      throw new SolanaError(SOLANA_ERROR__FIXED_POINTS__SHAPE_MISMATCH, {
        ...
        expectedScale: (_a = expected.scale) != null ? _a : actual.scale,
        expectedScaleLabel: expected.scaleLabel,
        expectedSignedness: (_b = expected.signedness) != null ? _b : actual.signedness,
        expectedTotalBits: (_c = expected.totalBits) != null ? _c : actual.totalBits,
        operation
      });
    }
  }
  ...
  function applyDecimalsOption(kind, raw, currentDecimals, options) {
    var _a;
    const targetDecimals = options == null ? void 0 : options.decimals;
    ...
    const rescaled = roundDivision(kind, "toString", raw, divisor, (_a = options == null ? void 0 : options.rounding) != null ? _a : "strict");
  ...
  function getLamportsEncoder(innerEncoder) {
    return transformEncoder(
      innerEncoder,
      (value) => typeof value === "bigint" ? value : value.raw
    );
  }
  ...
  function isSolanaRpcResponse(notification) {
    return notification != null && typeof notification === "object" && "context" in notification && notification.context != null && typeof notification.context === "object" && "slot" in notification.context && typeof notification.context.slot === "bigint" && "value" in notification;
  }
  var memoizedSolFactory;
  var memoizedRawSolFactory;
  function solFactory(value, rounding) {
    if (!memoizedSolFactory) memoizedSolFactory = decimalFixedPoint("unsigned", 64, 9);
    return memoizedSolFactory(value, rounding);
  }
  function rawSolFactory(value) {
  ...
  function getMemoizedU64Encoder2() {
    if (!memoizedU64Encoder2) memoizedU64Encoder2 = getU64Encoder();
    return memoizedU64Encoder2;
  }
  function getMemoizedU64Decoder2() {
    if (!memoizedU64Decoder2) memoizedU64Decoder2 = getU64Decoder();
    return memoizedU64Decoder2;
  }
  function sol(value, rounding) {
  ...
  function getSolEncoder() {
    return transformEncoder(
      getMemoizedU64Encoder2(),
      (value) => typeof value === "bigint" ? value : value.raw
    );
  }
  function getSolDecoder() {
    return transformDecoder(getMemoizedU64Decoder2(), (value) => rawSolFactory(value));
  }
  function getSolCodec() {
  ...
  function getMessageDecoder2() {
    return transformDecoder(
      ...
      ({ addressTableLookups, ...restOfMessage }) => {
        if (!(addressTableLookups == null ? void 0 : addressTableLookups.length)) {
  ...
  function compileTransactionMessage(transactionMessage) {
    ...
    for (let i = 0; i < transactionMessage.instructions.length; i++) {
      const numAccountsInInstruction = (_b = (_a = transactionMessage.instructions[i].accounts) == null ? void 0 : _a.length) != null ? _b : 0;
  ...
  function getInstructionHeader(instruction, accountIndex) {
    var _a, _b, _c, _d;
    return {
      numInstructionAccounts: (_b = (_a = instruction.accounts) == null ? void 0 : _a.length) != null ? _b : 0,
      numInstructionDataBytes: (_d = (_c = instruction.data) == null ? void 0 : _c.byteLength) != null ? _d : 0,
  ...
  function getInstructionPayload(instruction, accountIndex) {
    var _a, _b, _c;
    return {
      instructionAccountIndices: (_b = (_a = instruction.accounts) == null ? void 0 : _a.map(({ address: address2 }) => accountIndex[address2])) != null ? _b : [],
      instructionData: (_c = instruction.data) != null ? _c : new Uint8Array()
    };
  }
  function compileTransactionMessage3(transactionMessage) {
    ...
    return {
      version: 1,
      ...lifetimeConstraint ? { lifetimeToken: getCompiledLifetimeToken(lifetimeConstraint) } : null,
      configMask: getTransactionConfigMask((_c = transactionMessage.config) != null ? _c : {}),
      configValues: getTransactionConfigValues((_d = transactionMessage.config) != null ? _d : {}),
      header: getCompiledMessageHeader(orderedAccounts),
  ...
  function getTransactionMessageComputeUnitLimit(transactionMessage) {
    ...
    switch (transactionMessage.version) {
      case 1:
        return (_a = transactionMessage.config) == null ? void 0 : _a.computeUnitLimit;
      default:
  ...
  function setTransactionMessageComputeUnitLimitUsingConfig(computeUnitLimit, transactionMessage) {
    var _a;
    const mergedConfig = { ...(_a = transactionMessage.config) != null ? _a : {}, computeUnitLimit };
  ...
  function decompileInstruction(instructionHeader, instructionPayload, accountMetas) {
    var _a;
    const programAddress = (_a = accountMetas[instructionHeader.programAccountIndex]) == null ? void 0 : _a.address;
    if (!programAddress) {
      throw new SolanaError(SOLANA_ERROR__TRANSACTION__FAILED_TO_DECOMPILE_INSTRUCTION_PROGRAM_ADDRESS_NOT_FOUND, {
  ...
  function getTransactionMessageHeapSize(transactionMessage) {
    ...
    switch (transactionMessage.version) {
      case 1:
        return (_a = transactionMessage.config) == null ? void 0 : _a.heapSize;
      default:
  ...
  function setTransactionMessageHeapSizeUsingConfig(heapSize, transactionMessage) {
    var _a;
    const mergedConfig = { ...(_a = transactionMessage.config) != null ? _a : {}, heapSize };
    const nextConfig = isV1ConfigEmpty(mergedConfig) ? void 0 : Object.freeze(mergedConfig);
    if (nextConfig === void 0) {
      const { config, ...rest } = transactionMessage;
      return Object.freeze(rest);
  ...
  function getTransactionMessageLoadedAccountsDataSizeLimit(transactionMessage) {
    ...
    switch (transactionMessage.version) {
      case 1:
        return (_a = transactionMessage.config) == null ? void 0 : _a.loadedAccountsDataSizeLimit;
      default:
  ...
  function setTransactionMessageLoadedAccountsDataSizeLimitUsingConfig(loadedAccountsDataSizeLimit, transactionMessage) {
    var _a;
    const mergedConfig = { ...(_a = transactionMessage.config) != null ? _a : {}, loadedAccountsDataSizeLimit };
    const nextConfig = isV1ConfigEmpty(mergedConfig) ? void 0 : Object.freeze(mergedConfig);
    if (nextConfig === void 0) {
      const { config, ...rest } = transactionMessage;
      return Object.freeze(rest);
  ...
  function getTransactionMessagePriorityFeeLamports(transactionMessage) {
    var _a;
    return (_a = transactionMessage.config) == null ? void 0 : _a.priorityFeeLamports;
  }
  function setTransactionMessagePriorityFeeLamports(priorityFeeLamports, transactionMessage) {
    var _a;
    const mergedConfig = { ...(_a = transactionMessage.config) != null ? _a : {}, priorityFeeLamports };
    const nextConfig = isV1ConfigEmpty(mergedConfig) ? void 0 : Object.freeze(mergedConfig);
    if (nextConfig === void 0) {
      const { config, ...rest } = transactionMessage;
      return Object.freeze(rest);
  ...
  async function grindKeyPairs(config) {
    ...
    if (typeof matches === "function") {
      ...
      matcher = (address2) => matches.test(address2);
    }
    if (amount <= 0) {
      return [];
    }
      ...
      const batch = await getAbortablePromise(
        Promise.all(
          Array.from({ length: concurrency }, async () => {
            ...
            const address2 = base58Decoder2.decode(publicKeyBytes);
            return { address: address2, keyPair };
          })
        ),
        abortSignal
      );
      for (const { address: address2, keyPair } of batch) {
  ...
  function getTransactionSizeLimit(transaction) {
    const VERSION_FLAG_MASK22 = 127;
    const firstByte = transaction.messageBytes[0];
    return (firstByte & VERSION_FLAG_MASK22) === 1 ? V1_TRANSACTION_SIZE_LIMIT : LEGACY_TRANSACTION_SIZE_LIMIT;
  }
  ...
  var DEFAULT_MAX_INSTRUCTIONS_PER_TRANSACTION = 16;
  var TRANSACTION_INSTRUCTION_LIMIT = 64;
  function resolveMaxInstructions(maxInstructions) {
    return maxInstructions != null ? maxInstructions : DEFAULT_MAX_INSTRUCTIONS_PER_TRANSACTION;
  }
  function assertValidMaxInstructionsPerTransaction(maxInstructions) {
    if (maxInstructions !== void 0 && (maxInstructions <= 0 || !Number.isInteger(maxInstructions) || maxInstructions > TRANSACTION_INSTRUCTION_LIMIT)) {
  ...
  function assertMaxInstructionsPerTransaction(numInstructions, maxInstructions) {
      ...
      getMessagePacker: () => {
        ...
        return Object.freeze({
          ...
          packMessageToCapacity: (message, config) => {
            ...
            assertValidMaxInstructionsPerTransaction(config == null ? void 0 : config.maxInstructions);
            const maxInstructions = resolveMaxInstructions(config == null ? void 0 : config.maxInstructions);
  ...
  function successfulSingleTransactionPlanResultFromTransaction(plannedMessage, transaction, context) {
    const signature2 = getSignatureFromTransaction(transaction);
    return Object.freeze({
      context: Object.freeze({ ...context != null ? context : {}, signature: signature2, transaction }),
      kind: "single",
  ...
  function failedSingleTransactionPlanResult(plannedMessage, error, context) {
    return Object.freeze({
      context: Object.freeze({ ...context != null ? context : {} }),
      error,
      kind: "single",
      planType: "transactionPlanResult",
      plannedMessage,
...
[Tx #${index + 1}${indicator}] ${error.message}`;
  ...
  function createFailedToExecuteTransactionPlanError(result, abortReason) {
    ...
    const context = {
      ...
      cause: (_a = findErrorFromTransactionPlanResult(result)) != null ? _a : abortReason
    };
    Object.defineProperty(context, "transactionPlanResult", {
      configurable: false,
      enumerable: false,
  ...
  function unwrapErrorWithPreflightData(error) {
    ...
    if (isSolanaError(error) && simulationCodes.includes(error.context.__code)) {
      ...
      return {
        ...
        preflightData,
        unwrappedError: (_b = error.cause) != null ? _b : error
      };
    }
...
`).join("")}`;
  ...
  function createTransactionPlanner(config) {
    return async (instructionPlan, { abortSignal, maxInstructionsPerTransaction } = {}) => {
      var _a;
      const resolvedMaxInstructionsPerTransaction = maxInstructionsPerTransaction != null ? maxInstructionsPerTransaction : config.maxInstructionsPerTransaction;
  ...
  async function traverseSequential2(instructionPlan, context) {
    ...
    if (mustEntirelyFitInParentCandidate) {
      const candidate2 = await selectAndMutateCandidate(
        ...
        (message) => fitEntirePlanInsideMessage(context, instructionPlan, message)
      );
      if (candidate2) {
        return null;
      }
  ...
  async function traverseMessagePacker(instructionPlan, context) {
    ...
    const transactionPlans = [];
    const candidates = [...context.parentCandidates];
    const packMessageToCapacity = (message) => messagePacker.packMessageToCapacity(message, {
  ...
  async function selectAndMutateCandidate(context, candidates, predicate) {
    for (const candidate of candidates) {
      try {
        ...
        if (isSolanaError(error, SOLANA_ERROR__INSTRUCTION_PLANS__MAX_INSTRUCTIONS_PER_TRANSACTION_EXCEEDED) || isSolanaError(error, SOLANA_ERROR__INSTRUCTION_PLANS__MESSAGE_CANNOT_ACCOMMODATE_PLAN) || isSolanaError(error, SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNT_ADDRESSES) || isSolanaError(error, SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNTS_IN_INSTRUCTION) || isSolanaError(error, SOLANA_ERROR__TRANSACTION__TOO_MANY_INSTRUCTIONS) || isSolanaError(error, SOLANA_ERROR__TRANSACTION__TOO_MANY_SIGNER_ADDRESSES)) ;
        else {
          throw error;
        }
      }
  ...
  function fitEntirePlanInsideMessage(context, instructionPlan, message) {
  ...
  var MAX_HARDWARE_WALLET_SIGNABLE_MESSAGE_BYTES = 1232;
  var SIGNING_DOMAIN_LENGTH_BYTES = 16;
  var VERSION_LENGTH_BYTES = 1;
  var APPLICATION_DOMAIN_LENGTH_BYTES = 32;
  var MESSAGE_FORMAT_LENGTH_BYTES = 1;
  var SIGNER_COUNT_LENGTH_BYTES = 1;
  var SIGNER_ADDRESS_LENGTH_BYTES = 32;
  var MESSAGE_LENGTH_BYTES = 2;
  function getPreambleLengthForRequiredSignatories(requiredSignatories) {
    return SIGNING_DOMAIN_LENGTH_BYTES + VERSION_LENGTH_BYTES + APPLICATION_DOMAIN_LENGTH_BYTES + MESSAGE_FORMAT_LENGTH_BYTES + SIGNER_COUNT_LENGTH_BYTES + requiredSignatories.length * SIGNER_ADDRESS_LENGTH_BYTES + MESSAGE_LENGTH_BYTES;
  }
  function assertFitsHardwareWalletSignableMessageByteLimit(putativeMessage) {
    const messageBodyLength = getUtf8Encoder().getSizeFromValue(putativeMessage.content.text);
    const maxBodyLength = MAX_HARDWARE_WALLET_SIGNABLE_MESSAGE_BYTES - getPreambleLengthForRequiredSignatories(putativeMessage.requiredSignatories);
  ...
  function createReactiveActionStore(fn) {
    ...
    const dispatchAsyncWithSignal = async (userSignal, ...args) => {
      currentController == null ? void 0 : currentController.abort();
  ...
  function createReactiveStoreFromDataPublisherFactory({
    ...
    function performConnect(callerSignal) {
      currentInnerController == null ? void 0 : currentInnerController.abort();
          ...
          const handleAbort = (e3) => {
            ...
            queueMicrotask(() => {
              if (coalescedRequest.numConsumers === 0) {
                ...
                abortController.abort(EXPLICIT_ABORT_TOKEN2 || (EXPLICIT_ABORT_TOKEN2 = createExplicitAbortToken2()));
              }
            });
  ...
  // ../transaction-introspection/dist/index.browser.mjs
  var EMPTY_LOADED_ADDRESSES = { readonly: [], writable: [] };
  function getLoadedAddresses(meta) {
    const loaded = meta == null ? void 0 : meta.loadedAddresses;
    return loaded != null ? loaded : EMPTY_LOADED_ADDRESSES;
  }
  ...
  function decodeFromBase64(rpcTx) {
    ...
    const { compiledMessage, transaction } = decodeFromWire(getBase64Encoder().encode(b64));
  ...
  function decodeFromBase58(rpcTx) {
    ...
    const { compiledMessage, transaction } = decodeFromWire(getBase58Encoder().encode(b58));
    return { compiledMessage, loadedAddresses: getLoadedAddresses(rpcTx.meta), transaction };
  }
  function decodeFromJson(rpcTx) {
    ...
    const getCompiledInstructions3 = () => message.instructions.map((ix) => ({
    ...
    switch (version) {
      case "legacy":
        compiledMessage = {
          header,
          instructions: getCompiledInstructions3(),
  ...
  function isBase64Response(rpcTx) {
    const t3 = rpcTx.transaction;
    return Array.isArray(t3) && t3[1] === "base64";
  }
  function isBase58Response(rpcTx) {
    const t3 = rpcTx.transaction;
    return Array.isArray(t3) && t3[1] === "base58";
  }
  function getJsonShapedMessage(rpcTx) {
    const t3 = rpcTx.transaction;
    if (typeof t3 !== "object" || t3 === null || Array.isArray(t3) || !("message" in t3)) return void 0;
    const message = t3.message;
  ...
  function getAccountMetasFromCompiledTransactionMessage(compiledMessage, loadedAddresses) {
    ...
    if (loadedAddresses) {
      for (const address2 of loadedAddresses.writable) {
        metas.push({ address: address2, role: AccountRole.WRITABLE });
      }
      for (const address2 of loadedAddresses.readonly) {
        metas.push({ address: address2, role: AccountRole.READONLY });
      }
    }
    return metas;
  }
  ...
  function normalizeCompiledInstructions(compiledMessage) {
    if (compiledMessage.version === "legacy" || compiledMessage.version === 0) {
      return compiledMessage.instructions.map((ix) => {
        var _a, _b;
        return {
          accountIndices: (_a = ix.accountIndices) != null ? _a : [],
          data: (_b = ix.data) != null ? _b : new Uint8Array(),
  ...
  function createReactiveStoreWithInitialValueAndSlotTracking({
    ...
    function performConnect(callerSignal) {
      ...
      function handleSlottedValue({ context: { slot }, value }) {
        if (signal.aborted) return;
        if (slot < lastUpdateSlot) {
          if (currentState.data !== void 0) {
            setState({ data: currentState.data, error: void 0, status: "loaded" });
          }
          return;
        }
        lastUpdateSlot = slot;
        setState({ data: { context: { slot }, value }, error: void 0, status: "loaded" });
      }
  ...
  async function getTimeoutPromise({ abortSignal: callerAbortSignal, commitment }) {
    ...
    try {
      return await new Promise((_, reject) => {
        ...
        timeoutId = // We use `setTimeout` instead of `AbortSignal.timeout()` because we want to measure
  ...
  // src/compute-unit-limit-estimation.ts
  ...
  function estimateComputeUnitLimitFactory({
    ...
    return async function estimateComputeUnitLimit(transactionMessage, config) {
      const { abortSignal, ...simulateConfig } = config != null ? config : {};
      ...
      try {
        ...
        if (isSolanaError(e3, SOLANA_ERROR__TRANSACTION__FAILED_WHEN_SIMULATING_TO_ESTIMATE_COMPUTE_LIMIT)) {
          throw e3;
        }
        throw new SolanaError(SOLANA_ERROR__TRANSACTION__FAILED_TO_ESTIMATE_COMPUTE_LIMIT, {
          cause: e3
  ...
  async function decompileTransactionMessageFetchingLookupTables(compiledTransactionMessage, rpc, config) {
    ...
    return decompileTransactionMessage4(compiledTransactionMessage, {
      addressesByLookupTableAddress,
      lastValidBlockHeight
    });
  }

  // src/resource-limit-estimation.ts
  ...
  function estimateResourceLimitsFactory({
    ...
    return async function estimateResourceLimits(transactionMessage, config) {
      ...
      try {
        ...
        if (isSolanaError(e3, SOLANA_ERROR__TRANSACTION__FAILED_WHEN_SIMULATING_TO_ESTIMATE_RESOURCE_LIMITS) || isSolanaError(e3, SOLANA_ERROR__TRANSACTION__FAILED_TO_ESTIMATE_LOADED_ACCOUNTS_DATA_SIZE_LIMIT)) {
          throw e3;
        }
        throw new SolanaError(SOLANA_ERROR__TRANSACTION__FAILED_TO_ESTIMATE_COMPUTE_LIMIT, {
          cause: e3
  ...
  exports.SOLANA_ERROR__FAILED_TO_SEND_TRANSACTIONS = SOLANA_ERROR__FAILED_TO_SEND_TRANSACTIONS;
  exports.SOLANA_ERROR__FIXED_POINTS__ARITHMETIC_OVERFLOW = SOLANA_ERROR__FIXED_POINTS__ARITHMETIC_OVERFLOW;
  exports.SOLANA_ERROR__FIXED_POINTS__DIVISION_BY_ZERO = SOLANA_ERROR__FIXED_POINTS__DIVISION_BY_ZERO;
  exports.SOLANA_ERROR__FIXED_POINTS__FRACTIONAL_BITS_EXCEED_TOTAL_BITS = SOLANA_ERROR__FIXED_POINTS__FRACTIONAL_BITS_EXCEED_TOTAL_BITS;
  exports.SOLANA_ERROR__FIXED_POINTS__INVALID_DECIMALS = SOLANA_ERROR__FIXED_POINTS__INVALID_DECIMALS;
  exports.SOLANA_ERROR__FIXED_POINTS__INVALID_FRACTIONAL_BITS = SOLANA_ERROR__FIXED_POINTS__INVALID_FRACTIONAL_BITS;
  exports.SOLANA_ERROR__FIXED_POINTS__INVALID_STRING = SOLANA_ERROR__FIXED_POINTS__INVALID_STRING;
  exports.SOLANA_ERROR__FIXED_POINTS__INVALID_TOTAL_BITS = SOLANA_ERROR__FIXED_POINTS__INVALID_TOTAL_BITS;
  exports.SOLANA_ERROR__FIXED_POINTS__INVALID_ZERO_DENOMINATOR_RATIO = SOLANA_ERROR__FIXED_POINTS__INVALID_ZERO_DENOMINATOR_RATIO;
  exports.SOLANA_ERROR__FIXED_POINTS__MALFORMED_RAW_VALUE = SOLANA_ERROR__FIXED_POINTS__MALFORMED_RAW_VALUE;
  exports.SOLANA_ERROR__FIXED_POINTS__SHAPE_MISMATCH = SOLANA_ERROR__FIXED_POINTS__SHAPE_MISMATCH;
  exports.SOLANA_ERROR__FIXED_POINTS__STRICT_MODE_PRECISION_LOSS = SOLANA_ERROR__FIXED_POINTS__STRICT_MODE_PRECISION_LOSS;
  exports.SOLANA_ERROR__FIXED_POINTS__TOTAL_BITS_NOT_BYTE_ALIGNED = SOLANA_ERROR__FIXED_POINTS__TOTAL_BITS_NOT_BYTE_ALIGNED;
  exports.SOLANA_ERROR__FIXED_POINTS__VALUE_OUT_OF_RANGE = SOLANA_ERROR__FIXED_POINTS__VALUE_OUT_OF_RANGE;
  exports.SOLANA_ERROR__FS__UNSUPPORTED_ENVIRONMENT = SOLANA_ERROR__FS__UNSUPPORTED_ENVIRONMENT;
  ...
  exports.SOLANA_ERROR__INSTRUCTION_PLANS__INVALID_MAX_INSTRUCTIONS_PER_TRANSACTION = SOLANA_ERROR__INSTRUCTION_PLANS__INVALID_MAX_INSTRUCTIONS_PER_TRANSACTION;
  exports.SOLANA_ERROR__INSTRUCTION_PLANS__MAX_INSTRUCTIONS_PER_TRANSACTION_EXCEEDED = SOLANA_ERROR__INSTRUCTION_PLANS__MAX_INSTRUCTIONS_PER_TRANSACTION_EXCEEDED;
  ...
  exports.SOLANA_ERROR__KEYS__INVALID_BASE58_IN_GRIND_REGEX = SOLANA_ERROR__KEYS__INVALID_BASE58_IN_GRIND_REGEX;
  ...
  exports.SOLANA_ERROR__KEYS__WRITE_KEY_PAIR_UNSUPPORTED_ENVIRONMENT = SOLANA_ERROR__KEYS__WRITE_KEY_PAIR_UNSUPPORTED_ENVIRONMENT;
  ...
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_ACCOUNT = SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_ACCOUNT;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION = SOLANA_ERROR__PROGRAM_CLIENTS__FAILED_TO_IDENTIFY_INSTRUCTION;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS = SOLANA_ERROR__PROGRAM_CLIENTS__INSUFFICIENT_ACCOUNT_METAS;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__RESOLVED_INSTRUCTION_INPUT_MUST_BE_NON_NULL = SOLANA_ERROR__PROGRAM_CLIENTS__RESOLVED_INSTRUCTION_INPUT_MUST_BE_NON_NULL;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__UNEXPECTED_RESOLVED_INSTRUCTION_INPUT_TYPE = SOLANA_ERROR__PROGRAM_CLIENTS__UNEXPECTED_RESOLVED_INSTRUCTION_INPUT_TYPE;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_ACCOUNT_TYPE = SOLANA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_ACCOUNT_TYPE;
  exports.SOLANA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_INSTRUCTION_TYPE = SOLANA_ERROR__PROGRAM_CLIENTS__UNRECOGNIZED_INSTRUCTION_TYPE;
  exports.SOLANA_ERROR__REACT__MISSING_CAPABILITY = SOLANA_ERROR__REACT__MISSING_CAPABILITY;
  exports.SOLANA_ERROR__REACT__MISSING_PROVIDER = SOLANA_ERROR__REACT__MISSING_PROVIDER;
  exports.SOLANA_ERROR__REACT__SUBSCRIPTION_CLOSED_WITHOUT_ERROR = SOLANA_ERROR__REACT__SUBSCRIPTION_CLOSED_WITHOUT_ERROR;
  ...
  exports.SOLANA_ERROR__SIGNER__WALLET_ACCOUNT_CANNOT_SIGN_TRANSACTION = SOLANA_ERROR__SIGNER__WALLET_ACCOUNT_CANNOT_SIGN_TRANSACTION;
  exports.SOLANA_ERROR__SIGNER__WALLET_MULTISIGN_UNIMPLEMENTED = SOLANA_ERROR__SIGNER__WALLET_MULTISIGN_UNIMPLEMENTED;
  exports.SOLANA_ERROR__SUBSCRIBABLE__RETRY_NOT_SUPPORTED = SOLANA_ERROR__SUBSCRIBABLE__RETRY_NOT_SUPPORTED;
  ...
  exports.SOLANA_ERROR__TRANSACTION_INTROSPECTION__CANNOT_DECODE_JSON_PARSED_TRANSACTION = SOLANA_ERROR__TRANSACTION_INTROSPECTION__CANNOT_DECODE_JSON_PARSED_TRANSACTION;
  exports.SOLANA_ERROR__TRANSACTION_INTROSPECTION__UNRECOGNIZED_GET_TRANSACTION_RESPONSE = SOLANA_ERROR__TRANSACTION_INTROSPECTION__UNRECOGNIZED_GET_TRANSACTION_RESPONSE;
  ...
  exports.SOLANA_ERROR__TRANSACTION__FAILED_TO_DECOMPILE_INSTRUCTION_ACCOUNT_INDEX_OUT_OF_RANGE = SOLANA_ERROR__TRANSACTION__FAILED_TO_DECOMPILE_INSTRUCTION_ACCOUNT_INDEX_OUT_OF_RANGE;
  ...
  exports.SOLANA_ERROR__TRANSACTION__MALFORMED_MESSAGE_BYTES = SOLANA_ERROR__TRANSACTION__MALFORMED_MESSAGE_BYTES;
  ...
  exports.SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNTS_IN_INSTRUCTION = SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNTS_IN_INSTRUCTION;
  exports.SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNT_ADDRESSES = SOLANA_ERROR__TRANSACTION__TOO_MANY_ACCOUNT_ADDRESSES;
  exports.SOLANA_ERROR__TRANSACTION__TOO_MANY_INSTRUCTIONS = SOLANA_ERROR__TRANSACTION__TOO_MANY_INSTRUCTIONS;
  exports.SOLANA_ERROR__TRANSACTION__TOO_MANY_SIGNER_ADDRESSES = SOLANA_ERROR__TRANSACTION__TOO_MANY_SIGNER_ADDRESSES;
  ...
  exports.createDependentStructDecoder = createDependentStructDecoder;
  ...
  exports.getPatternMatchCodec = getPatternMatchCodec;
  exports.getPatternMatchDecoder = getPatternMatchDecoder;
  exports.getPatternMatchEncoder = getPatternMatchEncoder;
  exports.getPredicateCodec = getPredicateCodec;
  exports.getPredicateDecoder = getPredicateDecoder;
  exports.getPredicateEncoder = getPredicateEncoder;
  ...
  exports.getSolCodec = getSolCodec;
  exports.getSolDecoder = getSolDecoder;
  exports.getSolEncoder = getSolEncoder;
  ...
  exports.isSolanaRpcResponse = isSolanaRpcResponse;
