...
var transactionIntrospection = require('@solana/transaction-introspection');
...
Object.keys(subscribable).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return subscribable[k]; }
  });
});
Object.keys(transactionIntrospection).forEach(function (k) {
  if (k !== 'default' && !Object.prototype.hasOwnProperty.call(exports, k)) Object.defineProperty(exports, k, {
    enumerable: true,
    get: function () { return transactionIntrospection[k]; }
  });
});
