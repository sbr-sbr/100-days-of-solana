 ...
 * ```
 */
export declare function isSolanaRpcResponse<T>(notification: SolanaRpcResponse<UnwrapRpcResponse<T>> | T): notification is SolanaRpcResponse<UnwrapRpcResponse<T>>;
