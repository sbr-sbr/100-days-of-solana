...
var fixedPoints = require('@solana/fixed-points');
...
function solFactory(value, rounding) {
  if (!memoizedSolFactory) memoizedSolFactory = fixedPoints.decimalFixedPoint("unsigned", 64, 9);
  return memoizedSolFactory(value, rounding);
}
function rawSolFactory(value) {
  if (!memoizedRawSolFactory) memoizedRawSolFactory = fixedPoints.rawDecimalFixedPoint("unsigned", 64, 9);
  return memoizedRawSolFactory(value);
}
var memoizedU64Encoder2;
var memoizedU64Decoder2;
function getMemoizedU64Encoder2() {
  if (!memoizedU64Encoder2) memoizedU64Encoder2 = codecsNumbers.getU64Encoder();
  return memoizedU64Encoder2;
}
function getMemoizedU64Decoder2() {
  if (!memoizedU64Decoder2) memoizedU64Decoder2 = codecsNumbers.getU64Decoder();
...
function getSolDecoder() {
  return codecsCore.transformDecoder(getMemoizedU64Decoder2(), (value) => rawSolFactory(value));
}
function getSolCodec() {
  return codecsCore.combineCodec(getSolEncoder(), getSolDecoder());
}
