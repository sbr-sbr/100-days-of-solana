...
function getCompiledTransactionConfigValueEncoder() {
  return codecsDataStructures.getPatternMatchEncoder([
    [
      ...
      codecsCore.transformEncoder(codecsDataStructures.getStructEncoder([["value", codecsNumbers.getU32Encoder()]]), (value) => value)
    ],
    [
      (value) => value.kind === "u64",
      codecsCore.transformEncoder(codecsDataStructures.getStructEncoder([["value", codecsNumbers.getU64Encoder()]]), (value) => value)
    ]
  ]);
}
