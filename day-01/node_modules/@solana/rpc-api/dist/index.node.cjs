...
function getAllowedNumericKeypaths() {
  if (!memoizedKeypaths) {
    memoizedKeypaths = {
      ...
      getSignaturesForAddress: [[rpcTransformers.KEYPATH_WILDCARD, "transactionIndex"]],
      ...
      getVoteAccounts: [
        ...
        ["current", rpcTransformers.KEYPATH_WILDCARD, "inflationRewardsCommissionBps"],
        ["delinquent", rpcTransformers.KEYPATH_WILDCARD, "commission"],
        ["delinquent", rpcTransformers.KEYPATH_WILDCARD, "inflationRewardsCommissionBps"]
      ],
      simulateTransaction: [
