 ...
 */
type GetTransactionApiResponseEnvelope<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = GetTransactionApiResponseBase & (TMaxSupportedTransactionVersion extends void ? Record<string, never> : {
 ...
 */
type TransactionMetaNotParsed<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = (TransactionMetaBase & TransactionMetaInnerInstructionsNotParsed & (TMaxSupportedTransactionVersion extends void ? Record<string, never> : TransactionMetaLoadedAddresses)) | null;
/**
 * The shape of a non-null `getTransaction` response when called with
 * `encoding: 'base64'`.
 */
export type GetTransactionApiResponseBase64<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = GetTransactionApiResponseEnvelope<TMaxSupportedTransactionVersion> & {
 ...
 * `encoding: 'base58'`.
 */
export type GetTransactionApiResponseBase58<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = GetTransactionApiResponseEnvelope<TMaxSupportedTransactionVersion> & {
    meta: TransactionMetaNotParsed<TMaxSupportedTransactionVersion>;
 ...
 */
export type GetTransactionApiResponseJson<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = GetTransactionApiResponseEnvelope<TMaxSupportedTransactionVersion> & {
    meta: TransactionMetaNotParsed<TMaxSupportedTransactionVersion>;
 ...
 */
export type GetTransactionApiResponseJsonParsed<TMaxSupportedTransactionVersion extends TransactionVersion | void = void> = GetTransactionApiResponseEnvelope<TMaxSupportedTransactionVersion> & {
